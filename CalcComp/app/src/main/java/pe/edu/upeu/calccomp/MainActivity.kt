                ...
                .clickable(
                    ...
                    onClick = {
                        ...
                        if (valuex.equals("+") || valuex.equals("-") || valuex.equals("*") || valuex.equals("/")
                            || valuex.equals("%") || valuex.equals("^") || valuex.equals("√") || valuex.equals("√")
                            || valuex.equals("1/x") || valuex.equals("π")
                        ) {
                        ...
                        if (valuex.equals("=")) {
                            if (oldTextState.isNotEmpty()) {
                                ...
                                when (op) {
                                    ...
                                    "%" -> {
                                        finalNumber = (oldTextState.toDouble() / 100) * textState.toDouble()
                                    }
                                    "^" -> {
                                        finalNumber = Math.pow(oldTextState.toDouble(),textState.toDouble())
                                    }
                                    "√" -> {
                                        finalNumber = Math.sqrt(oldTextState.toDouble())
                                    }
                                    "1/x" -> {
                                        finalNumber = 1 / oldTextState.toDouble()
                                    }
                                    "π" -> {
                                        finalNumber = Math.PI
                                    }
